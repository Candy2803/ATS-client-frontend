...
const PastaComponent = ({onItemClick}) => {
  ...
  const pastaItems = [
    ...
    },
    {
      ...
      discountPrice: null,
      discountPercentage: null,
      image: 'https://images.unsplash.com/photo-1546549032-9571cd6b27df?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cGFzdGF8ZW58MHx8MHx8fDA%3D'
    },
    {
      id: 4,
      name: 'Pasta 4',
      ...
      discountPrice: null,
      discountPercentage: null,
      image: 'https://images.unsplash.com/photo-1611270629569-8b357cb88da9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8cGFzdGF8ZW58MHx8MHx8fDA%3D'
    }
  ];
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col md:ml-64">
        ...
        <h1 className="text-4xl font-bold flex-1">Pasta</h1>
